...
<template>
  <UForm :schema="schema" :state="state" class="space-y-4" @submit="onSubmit">
    <UFormGroup label="Nom du tag" name="name">
      <UInput placeholder="ex: Tokyo, Déménagment, Anniversaire, …" v-model="state.name" />
    </UFormGroup>
